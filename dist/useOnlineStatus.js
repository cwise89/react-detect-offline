...
export const needPolling = inBrowser && unsupportedUserAgentsPattern.test(navigator.userAgent);
...
function getPollingConfig(polling) {
    switch (polling) {
        case true:
...
function noop() { }
export function useOnlineStatus(polling = needPolling, onChange = noop) {
